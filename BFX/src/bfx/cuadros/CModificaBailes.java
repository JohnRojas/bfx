/* Nombre de la clase                : CModificaBailes
 * Descripción de la clase        : Clase que permite modificar los datos de un Baile
...
/**
 * Interfaz gráfica de usuario para modificar un baile
 * @author Techno Engineers
 * @version 1.0
 */
public class CModificaBailes extends javax.swing.JFrame {
     ...
     */
    public CModificaBailes() {
        initComponents();
        this.setLayout(null);
        this.setLocationRelativeTo(null);
        fondo = new CPanelFondo("Modifica Bailes ...", "../imagenes/ballet.png", 0, 0, 420, 380);
        this.add(fondo);
        ...
        InputMap map2 = objTFDuracion.getInputMap(objTFDuracion.WHEN_FOCUSED);
        map1.put(KeyStroke.getKeyStroke(KeyEvent.VK_V, Event.CTRL_MASK), "null");

    }
    
    public void Limitar(){
        objTFDuracion.setDocument(new CLimitarCaracter(objTFDuracion, 5));
    }
    ...
    public int metpbValidaCamposVacios() {
        if (objTFNombre.getText().equals("")) {
            ...
            return 1;
        } else if (objTFDuracion.getText().equals("")) {
            CMensajes.cmetpbFalla(this, "El campo de duracion no debe estar en blanco");
            objTFDuracion.requestFocus();
            return 1;
        }
        return 0;
    ...
    private void initComponents()
    {
        ...
        objTFDuracion.addKeyListener(new java.awt.event.KeyAdapter()
        {
            public void keyPressed(java.awt.event.KeyEvent evt)
            {
                objTFDuracionKeyPressed(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt)
            {
                objTFDuracionKeyTyped(evt);
            }
        });
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(objTFNombre, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(objCBBaile, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(objCBRegiones, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
    ...
    private void objBAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_objBAceptarActionPerformed
        ...
        if (lEValida == 0) {
            String lSDuracion = "00:" + objTFDuracion.getText();
            //System.out.println("dur = " + dur);
            CBailes objCBailes1 = new CBailes(1, objTFNombre.getText(),
                    lSDuracion, objCBEstatus.getSelectedIndex(),
                    lEidRegiones);
            //System.out.println(obj);
            String lSDatos = "'" + objCBailes1.getPvCnombreBaile() + "','"
                    + objCBailes1.getPvCduracion() + "',"
                    + objCBailes1.getPvEestatus();
            Connection lCNConexion = CManipulaDB.cmetpbConectaDB();
            CQuerys objCQuerys2 = new CQuerys();
            String lSBailes = objCQuerys2.metpbSModificar(lCNConexion, "bailes", "nombre, duracion, status", lSDatos, "idbaile=" + lEidBailes);
            if (lSBailes == null) {
    ...
    private void objTFNombreKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_objTFNombreKeyPressed
        // TODO add your handling code here:
        if (evt.getKeyChar() == '\n') {
            CManipulaInterfaz.cmetpbHabilita(true, objTFDuracion);
            CManipulaInterfaz.cmetpbCambiaCuadro(objTFDuracion);
        }
    ...
    private void objTFDuracionKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_objTFDuracionKeyPressed
        // TODO add your handling code here:
        if (evt.getKeyChar() == '\n') {
            CManipulaInterfaz.cmetpbHabilita(true, objCBEstatus);
            CManipulaInterfaz.cmetpbCambiaCuadro(objCBEstatus);
        }
    }//GEN-LAST:event_objTFDuracionKeyPressed

    private void objTFDuracionKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_objTFDuracionKeyTyped
        // TODO add your handling code here:
        CValidaciones.cmetpbHora(evt);
    }//GEN-LAST:event_objTFDuracionKeyTyped
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CModificaBailes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
